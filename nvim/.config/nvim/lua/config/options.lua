...
vim.opt.autowrite = true -- Auto-save on supported write events
...
vim.opt.showtabline = 2 -- Always show tabline (for buffers/tabs at top)

-- Cursor Settings
vim.opt.guicursor = {
  'n-v-c:block', -- Normal, Visual, Command-line
  'i-ci-ve:ver25', -- Insert, Command-line Insert, Visual-exclusive (line cursor)
...
-- List characters
vim.o.list = true -- Enable list
vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' } -- Set how listchars will look
