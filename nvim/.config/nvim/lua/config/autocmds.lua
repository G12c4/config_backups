...
-- Auto-save regular file buffers
local autosave_group = vim.api.nvim_create_augroup('AutoSaveBuffers', {})
vim.api.nvim_create_autocmd({ 'InsertLeave', 'TextChanged' }, {
  ...
  callback = function(args)
    ...
    if vim.fn.bufname(bufnr) == '' or not vim.bo[bufnr].modified then
      return
    end
